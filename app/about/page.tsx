...
function BrandMark() {
  return (
    <span className="relative grid h-6 w-6 shrink-0 rotate-45 place-items-center border border-[#111318]">
      <span className="absolute inset-[3px] border border-[#087e9b]" />
      <span className="absolute inset-[7px] border border-[#087e9b]" />
  ...
  return (
    <main className="about-page min-h-screen overflow-hidden bg-[#f4f6f8] text-[#111318]">
      ...
      <section className="about-hero relative flex min-h-[92vh] items-center overflow-hidden px-[7vw] pb-24 pt-36">
        ...
        <div className="about-scan absolute inset-x-0 top-0 h-px bg-[#087e9b]/30" />
        <div className="relative z-10 max-w-[820px]">
          <div className="about-reveal font-mono text-[8px] tracking-[.18em] text-[#087e9b]">01 / ABOUT TECHCRAFT</div>
          <div className="mt-7 overflow-hidden">
            <h1 className="about-title about-reveal text-[clamp(64px,10vw,156px)] font-medium leading-[.81] tracking-[-.09em]">
              We build with<br />
              <span className="text-[#087e9b]">intent.</span>
            </h1>
          </div>
        ...
        <div className="about-orbit absolute -right-28 top-[64%] hidden aspect-square w-[46vw] max-w-[690px] -translate-y-1/2 md:block" aria-hidden="true">
          <div className="about-orbit-ring about-orbit-ring-a absolute inset-[4%] rounded-full border border-[#087e9b]/15" />
          <div className="about-orbit-ring about-orbit-ring-b absolute inset-[15%] rotate-45 rounded-[38%] border border-[#087e9b]/20" />
          <div className="about-orbit-ring about-orbit-ring-c absolute inset-[28%] rounded-full border border-[#087e9b]/25" />
          <div className="about-orbit-core absolute left-1/2 top-1/2 grid h-28 w-28 -translate-x-1/2 -translate-y-1/2 place-items-center border border-[#087e9b] bg-white/60 font-mono text-xs shadow-[0_20px_70px_rgba(0,155,190,.14)] backdrop-blur-sm">
            <BrandLogo height={64} />
          </div>
          <span className="about-orbit-dot absolute left-[21%] top-[26%] h-2 w-2 rounded-full bg-[#087e9b]" />
        ...
        <div className="grid gap-16 lg:grid-cols-[1.2fr_.8fr] lg:gap-[9vw]">
          <div>
            <h2 className="about-reveal text-[clamp(48px,6vw,91px)] font-medium leading-[.88] tracking-[-.08em]">
              Technology is only useful when it <span className="text-[#087e9b]">moves people forward.</span>
            </h2>
          ...
          <div className="self-end">
            <div className="about-side-card border border-black/10 bg-white/55 p-7 shadow-[0_25px_70px_rgba(17,24,39,.06)] backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <span className="font-mono text-[8px] tracking-[.16em] text-[#087e9b]">TC / 001</span>
                <Sparkles size={17} className="text-[#d7a52a]" />
              </div>
              <div className="mt-12 h-px w-16 bg-[#087e9b]" />
      ...
      <section className="grid gap-10 px-[7vw] py-28 lg:grid-cols-[130px_1fr] lg:gap-14">
        ...
        <div>
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <h2 className="about-reveal max-w-[780px] text-[clamp(48px,6vw,90px)] font-medium leading-[.88] tracking-[-.08em]">From first thought to <span className="text-[#087e9b]">working system.</span></h2>
          ...
          <div className="grid border-l border-t border-black/10 sm:grid-cols-2">
            {capabilities.map(([Icon, title, description], index) => (
              <article key={title} className={`about-capability about-stagger-${index + 1} group relative min-h-[285px] overflow-hidden border-b border-r border-black/10 bg-white/20 p-7 transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-[0_24px_60px_rgba(17,24,39,.07)]`}>
                <div className="absolute right-0 top-0 h-24 w-24 translate-x-8 -translate-y-8 rounded-full bg-[#087e9b]/[.05] transition duration-500 group-hover:scale-150" />
                <div className="relative flex items-center justify-between">
                  <span className="font-mono text-[8px] text-[#087e9b]">0{index + 1}</span>
                  <ArrowUpRight className="text-black/20 transition duration-500 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-[#087e9b]" size={18} />
                </div>
                <div className="relative mt-10 grid h-12 w-12 place-items-center border border-black/10 bg-white/55 text-[#087e9b] transition duration-500 group-hover:rotate-45 group-hover:border-[#087e9b] group-hover:bg-[#087e9b] group-hover:text-white">
      ...
      <section className="relative overflow-hidden bg-[#07182f] px-[7vw] py-32 text-white">
        ...
        <div className="relative z-10 grid gap-14 lg:grid-cols-[.9fr_1.1fr] lg:gap-[10vw]">
          <div>
            <div className="about-reveal font-mono text-[8px] tracking-[.16em] text-[#65d9ee]">04 / HOW WE WORK</div>
            <h2 className="about-reveal mt-7 text-[clamp(52px,6vw,92px)] font-medium leading-[.86] tracking-[-.08em]">A process built for <span className="text-[#65d9ee]">momentum.</span></h2>
          ...
          <div className="border-t border-white/10">
            {process.map(([number, title, description, Icon], index) => (
              <div key={number} className={`about-process about-stagger-${index + 1} group grid gap-5 border-b border-white/10 py-7 sm:grid-cols-[48px_1fr_42px] sm:items-start`}>
                ...
                <div>
                  <h3 className="text-[25px] font-medium tracking-[-.05em] transition group-hover:text-[#65d9ee]">{title}</h3>
                  <p className="mt-2 max-w-[470px] text-xs leading-7 text-white/40">{description}</p>
                </div>
                <div className="mt-1 grid h-9 w-9 place-items-center border border-white/10 text-white/45 transition duration-500 group-hover:rotate-45 group-hover:border-[#65d9ee]/50 group-hover:text-[#65d9ee]">
      ...
      <section className="grid gap-10 bg-[#e9edf2] px-[7vw] py-28 lg:grid-cols-[130px_1fr] lg:gap-14">
        ...
        <div>
          <div className="max-w-[760px]">
            <h2 className="about-reveal text-[clamp(52px,6vw,92px)] font-medium leading-[.86] tracking-[-.08em]">The standard behind every <span className="text-[#087e9b]">decision.</span></h2>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#f7f8fa] px-[7vw] py-28">
        <div className="absolute -right-24 top-1/2 h-[340px] w-[340px] -translate-y-1/2 rounded-full border border-[#087e9b]/10" />
        ...
        <div className="relative z-10 grid items-end gap-12 lg:grid-cols-[1fr_auto]">
          <div>
            <div className="about-reveal font-mono text-[8px] tracking-[.16em] text-[#087e9b]">06 / PERSPECTIVE</div>
            <h2 className="about-reveal mt-7 max-w-[900px] text-[clamp(54px,7.2vw,112px)] font-medium leading-[.84] tracking-[-.085em]">Local perspective.<br /><span className="text-[#087e9b]">Global standard.</span></h2>
          ...
          <div className="about-location-card border border-black/10 bg-white/70 p-6 backdrop-blur-sm">
            ...
            <div className="mt-5 flex items-center gap-2 text-[9px] text-black/40"><span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#087e9b]" /> Building beyond borders</div>
          </div>
        </div>
      </section>
      ...
      <section className="about-cta flex min-h-[540px] flex-col justify-between overflow-hidden bg-[#07182f] px-[7vw] py-28 text-white md:flex-row md:items-end">
        <div className="relative z-10">
          <div className="about-reveal font-mono text-[8px] tracking-[.16em] text-[#65d9ee]">07 / NEXT</div>
          <h2 className="about-reveal mt-7 max-w-[880px] text-[clamp(58px,8vw,122px)] font-medium leading-[.82] tracking-[-.09em]">Have something worth<br /><span className="text-[#65d9ee]">building?</span></h2>
        ...
        <Link href="/#contact" className="about-cta-button mt-12 grid h-[154px] w-[154px] shrink-0 place-items-center rounded-full border border-[#65d9ee]/60 bg-[#087e9b] text-center text-[10px] shadow-[0_20px_60px_rgba(0,155,190,.22)] transition md:mt-0">
      ...
      <footer className="flex flex-col gap-4 border-t border-white/10 bg-[#07182f] px-[7vw] py-6 font-mono text-[7px] tracking-[.16em] text-white/30 sm:flex-row sm:items-center sm:justify-between">
        <Link href="/" className="flex items-center gap-3 text-white"><BrandMark /><span>TECH<span className="text-[#65d9ee]">CRAFT</span></span></Link>
