    ...
    <main className="portfolio-page min-h-screen overflow-hidden bg-[#f4f6f8] text-[#111318]">
      ...
      <section id="quetta-dry-fruit" className="portfolio-feature portfolio-feature-secondary border-t border-black/10 bg-white/65 px-[7vw] py-24">
        ...
        <div className="portfolio-project-shell">
          ...
          <div className="portfolio-project-copy"><div className="portfolio-project-index"><span>DIGITAL STOREFRONT</span><span>04 / 04</span></div><h3>A local brand shaped into a digital storefront.</h3><p>The project brings product presentation, brand clarity and responsive development together in a focused online shopping experience.</p><div className="portfolio-project-stats"><div><span>DISCIPLINE</span><strong>WEB DESIGN + DEVELOPMENT</strong></div><div><span>FOCUS</span><strong>COMMERCE + PRODUCT PRESENTATION</strong></div><div><span>EXPERIENCE</span><strong>RESPONSIVE STOREFRONT</strong></div><div><span>STATUS</span><strong>LIVE WEBSITE</strong></div></div><a href="https://quettadryfruit.binarygenius.tech/" target="_blank" rel="noreferrer" className="portfolio-live-link"><span>Visit quettadryfruit.binarygenius.tech</span><ArrowUpRight size={16} /></a></div>
        </div>
      </section>
