...
/**
 * Lightweight animated network background used by the home page.
 * Kept isolated from the page composition so the homepage component
 * can focus on layout and interaction state.
 */
export default function HomeNetworkCanvas() {
